...
function RollingTitle({ segments }: { segments: { text: string; className?: string }[] }) {
  let index = 0
  return (
    <h1 className="font-display text-lg sm:text-2xl lg:text-6xl font-bold text-white
           leading-tight mb-4 drop-shadow-lg italic whitespace-nowrap" style={{ wordSpacing: '-0.05em' }}>
      {segments.map((seg, s) => (
      ...
      */}
      ...
      <div className="relative z-10 w-full flex flex-col items-center justify-center px-6 py-10 sm:py-16 text-center">
        ...
        <p className="text-white text-xs sm:text-sm font-bold uppercase tracking-[0.2em] sm:tracking-[0.3em] mb-8 leading-[2.5]">
          ...
          Céleste<br />
          Paroisse BEULAH Kouti Kpinlè<br />
          Centre
        </p>
