...
class AuthController extends Controller
{
    ...
    public function forgotPassword(Request $request): JsonResponse
    {
        ...
        // Envoie le lien via la notification personnalisée (voir User::sendPasswordResetNotification)
        Password::sendResetLink($request->only('email'));

        // Toujours la même réponse pour éviter l'énumération d'emails
        return response()->json([
    ...
    public function resetPassword(Request $request): JsonResponse
    {
        ...
        $status = Password::reset(
            ...
            function (User $user, string $password) {
                ...
                // Révoque tous les anciens tokens Sanctum pour forcer une reconnexion
                $user->tokens()->delete();
